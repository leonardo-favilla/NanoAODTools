...
class nanoTopcand(Module):
    ...
    def beginFile(self, inputFile, outputFile, inputTree, wrappedOutputTree):
        ...
        self.out.branch("nTopHighPt",           "I")
        self.out.branch("TopHighPt_idxFatJet",  "I", lenVar="nTopHighPt")
        ...
        self.out.branch("TopHighPt_mass",       "F", lenVar="nTopHighPt")
        self.out.branch("TopHighPt_truth",      "F", lenVar="nTopHighPt")

        "branches Top candidate low pt"
        self.out.branch("nTopLowPt",            "I")
        self.out.branch("TopLowPt_idxJet0",     "I", lenVar="nTopLowPt")
        self.out.branch("TopLowPt_idxJet1",     "I", lenVar="nTopLowPt")
        self.out.branch("TopLowPt_idxJet2",     "I", lenVar="nTopLowPt")
        self.out.branch("TopLowPt_pt",          "F", lenVar="nTopLowPt")
        self.out.branch("TopLowPt_eta",         "F", lenVar="nTopLowPt")
        self.out.branch("TopLowPt_phi",         "F", lenVar="nTopLowPt")
        self.out.branch("TopLowPt_mass",        "F", lenVar="nTopLowPt")
        self.out.branch("TopLowPt_truth",       "F", lenVar="nTopLowPt")
    ...
    def analyze(self, event):
        ...
        self.out.fillBranch("nTopLowPt",            ntoplowpt)
        self.out.fillBranch("TopLowPt_idxJet0",     toplow_idxjet0)
        self.out.fillBranch("TopLowPt_idxJet1",     toplow_idxjet1)
        self.out.fillBranch("TopLowPt_idxJet2",     toplow_idxjet2)
        self.out.fillBranch("TopLowPt_pt",          toplow_pt_)
        self.out.fillBranch("TopLowPt_eta",         toplow_eta_)
        self.out.fillBranch("TopLowPt_phi",         toplow_phi_)
        self.out.fillBranch("TopLowPt_mass",        toplow_mass_)
        self.out.fillBranch("TopLowPt_truth",       toplow_truth)
        self.out.fillBranch("nTopHighPt",           ntophighpt)
        self.out.fillBranch("TopHighPt_idxFatJet",  tophigh_idxfatjet)
        self.out.fillBranch("TopHighPt_idxJet0",    tophigh_idxjet0)
        self.out.fillBranch("TopHighPt_idxJet1",    tophigh_idxjet1)
        self.out.fillBranch("TopHighPt_idxJet2",    tophigh_idxjet2)
        self.out.fillBranch("TopHighPt_pt",         tophigh_pt_)
        self.out.fillBranch("TopHighPt_eta",        tophigh_eta_)
        self.out.fillBranch("TopHighPt_phi",        tophigh_phi_)
        self.out.fillBranch("TopHighPt_mass",       tophigh_mass_)
        self.out.fillBranch("TopHighPt_truth",      tophigh_truth)
        return True