...
vars.append(variable(name="Eventag", title="Event Tag", nbins=4, xmin=0.5, xmax=4.5))
vars.append(variable(name="Eventag_matched", title="Event Tag matched with truth", nbins=4, xmin=0.5, xmax=4.5))

vars.append(variable(name="nClusters_Res", title="Number of Top Clusters Resolved (matched to Top region)", nbins=4, xmin=0.5, xmax=4.5))
vars.append(variable(name="nClusters_Mix", title="Number of Top Clusters Mixed (matched to Top region)", nbins=4, xmin=0.5, xmax=4.5))
vars.append(variable(name="nClusters_Mer", title="Number of Top Clusters Merged (matched to Top region)", nbins=4, xmin=0.5, xmax=4.5))
vars.append(variable(name="nClusters_Res_0", title="Number of Top Clusters Resolved (0)", nbins=4, xmin=0.5, xmax=4.5))
vars.append(variable(name="nClusters_Mix_0", title="Number of Top Clusters Mixed (0)", nbins=4, xmin=0.5, xmax=4.5))
vars.append(variable(name="nClusters_Mer_0", title="Number of Top Clusters Merged (0)", nbins=4, xmin=0.5, xmax=4.5))

vars.append(variable(name="top_Res_isolation_pt", title="Top Resolved isolation (p_{T})", nbins=20, xmin=0, xmax=2))
vars.append(variable(name="top_Mix_isolation_pt", title="Top Mixed isolation (p_{T})", nbins=20, xmin=0, xmax=2))
vars.append(variable(name="top_Mer_isolation_pt", title="Top Merged isolation (p_{T})", nbins=20, xmin=0, xmax=2))
vars.append(variable(name="top_Res_isolation_pt_True", title="True Top Resolved isolation (p_{T})", nbins=20, xmin=0, xmax=2))
vars.append(variable(name="top_Mix_isolation_pt_True", title="True Top Mixed isolation (p_{T})", nbins=20, xmin=0, xmax=2))
vars.append(variable(name="top_Mer_isolation_pt_True", title="True Top Merged isolation (p_{T})", nbins=20, xmin=0, xmax=2))
vars.append(variable(name="top_Res_isolation_pt_False", title="False Top Resolved isolation (p_{T})", nbins=20, xmin=0, xmax=2))
vars.append(variable(name="top_Mix_isolation_pt_False", title="False Top Mixed isolation (p_{T})", nbins=20, xmin=0, xmax=2))
vars.append(variable(name="top_Mer_isolation_pt_False", title="False Top Merged isolation (p_{T})", nbins=20, xmin=0, xmax=2))

vars.append(variable(name="top_Res_isolation_njet", title="Top Resolved isolation (n_{jet})", nbins=5, xmin=0, xmax=5))
vars.append(variable(name="top_Mix_isolation_njet", title="Top Mixed isolation (n_{jet})", nbins=5, xmin=0, xmax=5))
vars.append(variable(name="top_Mer_isolation_njet", title="Top Merged isolation (n_{jet})", nbins=5, xmin=0, xmax=5))
vars.append(variable(name="top_Res_isolation_njet_True", title="True Top Resolved isolation (n_{jet})", nbins=5, xmin=0, xmax=5))
vars.append(variable(name="top_Mix_isolation_njet_True", title="True Top Mixed isolation (n_{jet})", nbins=5, xmin=0, xmax=5))
vars.append(variable(name="top_Mer_isolation_njet_True", title="True Top Merged isolation (n_{jet})", nbins=5, xmin=0, xmax=5))
vars.append(variable(name="top_Res_isolation_njet_False", title="False Top Resolved isolation (n_{jet})", nbins=5, xmin=0, xmax=5))
vars.append(variable(name="top_Mix_isolation_njet_False", title="False Top Mixed isolation (n_{jet})", nbins=5, xmin=0, xmax=5))
vars.append(variable(name="top_Mer_isolation_njet_False", title="False Top Merged isolation (n_{jet})", nbins=5, xmin=0, xmax=5))
