...
parser.add_argument("-path_to_graphics",    dest="path_to_graphics",    default=False, required=False, type=str,  help="path where to save histos root file")
...
path_to_graphics    = options.path_to_graphics
...
### OutHistos Root File ###
if save_graphics:
    if not os.path.exists(path_to_graphics):
        os.makedirs(path_to_graphics)
    PlotsRFile  = ROOT.TFile(f"{path_to_graphics}/{dataset}_Plots.root", "RECREATE")
